  ...
  <div class="card">
    <div class="card-body">
      ...
      <div class="mb-3">
        ...
        <select class="form-select" v-model="localNsfw">
...
const emit = defineEmits(['update:q','update:nsfw','update:tags','update:sort','update:order','search'])

const localQ = computed({
  get: () => props.q,
  set: v => emit('update:q', v)
})
const localNsfw = computed({
  get: () => props.nsfw,
  set: v => emit('update:nsfw', v)
})
